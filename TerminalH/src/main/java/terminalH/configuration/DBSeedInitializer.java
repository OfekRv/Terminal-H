...
public class DBSeedInitializer {
    ...
    public ApplicationRunner initializer(SectionRepository sectionRepository, CategoryRepository categoryRepository) {
        return args ->
        {
            ...
            createOrUpdateSection("הלבשה תחתונה", Arrays.asList("הלבשה תחתונה", "פיג'מות והלבשה תחתונה", "תחתונים וגרביים", "מידות גדולות", "מחטבים", "גרבונים", "שינה ופנאי", "תחתונים", "חזיות"), sectionRepository, categoryRepository);
