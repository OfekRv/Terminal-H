...
public class DBSeedInitializer {
    ...
    public ApplicationRunner initializer(SectionRepository sectionRepository, CategoryRepository categoryRepository) {
        return args ->
        {
            ...
            createOrUpdateSection("בגדים", Arrays.asList("סוודרים וסווטשירטים", "ג'קטים ומעילים", "מכנסיים", "חולצות", "שמלות וחצאיות", "חליפות ואוברולים", "בגדים", "גוזיות ספורט", "טייצים ארוכים", "טייצים קצרים", "חולצות ספורט", "מכנסי ספורט קצרים", "ג'קטים ועליוניות", "גופיות ספורט", "חליפות", "מכנסי ספורט ארוכים", "ביגוד", "סריגים וסוודרים", "סוויטשרטים וקפוצונים", "שמלות", "חצאיות", "DENIM", "בגדי גוף ואוברולים", "סטים ומארזים", "מכנסיים ואוברולים", "מארזי טי שרט", "טי שירט" , "חולצות פולו"), sectionRepository, categoryRepository);
